...
Без манифеста участие в обмене означает «быть заведённым в чужой админке». С манифестом оператор становится участником, отдав ссылку: его прайс и мощности читает любая площадка, а не одна. Это же снимает вопрос «почему не сработало»: если модуль или версия не совпали, это видно до первого запроса, а не после.
...
Примеры лежат в [`examples/`](examples): оператор с глубоким прайсом, оператор с плоским прайсом из Excel и площадка.
